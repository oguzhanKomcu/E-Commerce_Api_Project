...
namespace ECommerceApi.Application.CQRS.Product.Handlers.Queries
{
    ...
    public class GetAllProductQueryHandler : IRequestHandler<GetAllProductQueryRequest, ProductListModel>
    {
        ...
        public async Task<ProductListModel> Handle(GetAllProductQueryRequest request, CancellationToken cancellationToken)
        {



            IPaginate<ECommerceApi.Domain.Entities.Product> models = await _productRepository.GetListAsync(include:
