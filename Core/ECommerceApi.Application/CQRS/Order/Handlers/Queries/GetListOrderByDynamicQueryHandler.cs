...
namespace ECommerceApi.Application.CQRS.Order.Handlers.Queries
{
    ...
    public class GetListOrderByDynamicQueryHandler: IRequestHandler<GetListOrderByDynamicQueryRequest, OrderListModel>
    {
        ...
        public async Task<OrderListModel> Handle(GetListOrderByDynamicQueryRequest request, CancellationToken cancellationToken)
        {


            //repositorymizdeki dynamic methodunu kullandık..
            IPaginate<Domain.Entities.Order> models = await _orderRepository.GetListByDynamicAsync(request.Dynamic, include:
